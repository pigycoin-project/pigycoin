...
# TestP2PConn: A peer we use to send messages to pigycoind, and store responses.
...
class CompactBlocksTest(PigycoinTestFramework):
    ...
    # This test actually causes pigycoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that pigycoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for pigycoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # pigycoind will not send blocktxn responses for blocks whose height is
