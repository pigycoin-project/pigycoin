...
"""Verify that starting pigycoin with -h works as expected."""

from test_framework.test_framework import PigycoinTestFramework
from test_framework.util import assert_equal

class HelpTest(PigycoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pigycoin with -h for help text")
        ...
        self.log.info("Start pigycoin with -version for version information")
        ...
        self.log.info("Start pigycoind with -fakearg to make sure it does not start")
