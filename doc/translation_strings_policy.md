...
This document provides guidelines for internationalization of the Pigycoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `pigycoin_en.ts` remains unchanged.
