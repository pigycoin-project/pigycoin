Pigycoin Core version 0.16.2 is now available from:

  <https://download.pigycoin.org/pigycoin-0.16.2/>
...
- #12843 `df38b13` Test starting pigycoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure pigycoind processes are cleaned up when tests end (sdaftuar)
...
- #13797 `6518bcd` pigycoinconsensus: invalid flags should be set to pigycoinconsensus_error type, add test cases covering pigycoinconsensus error codes (Thomas Kerin)
