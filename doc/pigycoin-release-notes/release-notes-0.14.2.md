...
Testnet3 has been deprecated and replaced with Testnet4. The server port has been changed to 19225 however the RPC port remains
the same (19332).
...
here, originally written for Pigycoin but can also be used for Pigycoin:
[reducing-pigycoind-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
