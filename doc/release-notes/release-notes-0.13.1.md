Pigycoin Core version 0.13.1 is now available from:

  <https://pigycoin.org/bin/pigycoin-core-0.13.1/>
...
- **Script versioning:** Segwit makes it easy for future soft forks to allow
  ...
  currently being researched by Pigycoin Core contributors that may use this
...
[versionbits FAQ]: https://pigycoincore.org/en/2016/06/08/version-bits-miners-faq/
...
- #8848 `7a34a46` Add NULLDUMMY verify flag in pigycoinconsensus.h (jl2012)
...
- #8940 `5b4192b` Add x9 service bit support to dnsseed.bluematt.me, seed.pigycoinstats.com (TheBlueMatt, cdecker)
- #8944 `685e4c7` Remove bogus assert on number of oubound connections. (TheBlueMatt)
- #8949 `0dbc48a` Be more agressive in getting connections to peers with relevant services (gmaxwell)

### Build system
- #8293 `fa5b249` Allow building libpigycoinconsensus without any univalue (luke-jr)
- #8492 `8b0bdd3` Allow building bench_pigycoin by itself (luke-jr)
...
- #8829 `2a8bca4` Add pigycoin-tx JSON tests (jnewbery)
- #8834 `1dd1783` blockstore: Switch to dumb dbm (MarcoFalke)
- #8835 `d87227d` nulldummy.py: Don't run unused code (MarcoFalke)
- #8836 `eb18cc1` pigycoin-util-test.py should fail if the output file is empty (jnewbery)
...
- #8860 `0bee740` util: Move wait_pigycoinds() into stop_nodes() (MarcoFalke)
...
- #8683 `8a7d7ff` Fix incorrect file name pigycoin.qrc  (pigycoinsSG)
...
- #8817 `bcf3806` update pigycoin-tx to output witness data (jnewbery)
