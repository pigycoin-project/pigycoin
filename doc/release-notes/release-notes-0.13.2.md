Pigycoin Core version 0.13.2 is now available from:
  ...
  <https://pigycoin.org/bin/pigycoin-core-0.13.2/>
...
- #8908 `4a974b2` Update pigycoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow pigycoin-tx to create v2 transactions (btcdrak)
