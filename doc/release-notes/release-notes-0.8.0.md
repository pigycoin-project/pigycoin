Pigycoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/pigycoin/files/Pigycoin/pigycoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Pigycoin
...
New/changed settings (command-line or pigycoin.conf file)
--------------------------------------------------------
