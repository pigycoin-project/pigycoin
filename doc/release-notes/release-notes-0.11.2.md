Pigycoin Core version 0.11.2 is now available from:

  <https://pigycoin.org/bin/pigycoin-core-0.11.2/>
...
- #6600 `1e672ae` Debian/Ubuntu: Include pigycoin-tx binary
- #6600 `2394f4d` Debian/Ubuntu: Split pigycoin-tx into its own package
