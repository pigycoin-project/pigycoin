...
#ifndef PIGYCOIN_WALLET_WALLET_H
#define PIGYCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this pigycoin node, and set to 0 for transactions that were created
...
#endif // PIGYCOIN_WALLET_WALLET_H
