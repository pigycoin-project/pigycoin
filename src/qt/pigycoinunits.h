...
#ifndef PIGYCOIN_QT_PIGYCOINUNITS_H
#define PIGYCOIN_QT_PIGYCOINUNITS_H
...
/** Pigycoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class PigycoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PigycoinUnits(QObject *parent);

    /** Pigycoin units.
      @note Source: https://en.pigycoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef PigycoinUnits::Unit PigycoinUnit;

#endif // PIGYCOIN_QT_PIGYCOINUNITS_H
