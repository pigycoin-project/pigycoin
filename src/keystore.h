...
#ifndef PIGYCOIN_KEYSTORE_H
#define PIGYCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/pigycoin/bips/blob/master/bip-0013.mediawiki
