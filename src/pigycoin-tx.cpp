...
static void SetupPigycoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " pigycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  pigycoin-tx [options] <hex-tx> [commands]  Update hex-encoded pigycoin transaction\n" +
            "or:     pigycoin-tx [options] -create [commands]   Create hex-encoded pigycoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pigycoin transaction
